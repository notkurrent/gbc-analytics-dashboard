...
_(Добавьте сюда ссылку или скриншоты готового дашборда и скриншот сообщения в Telegram перед отправкой задания)_
...
- **Дашборд (Vercel):** [Укажите ссылку на Vercel]
- **Репозиторий:** [Укажите ссылку на GitHub]
- **Скриншот уведомления:** _(Добавьте скриншот сюда или отправьте в Telegram)_
